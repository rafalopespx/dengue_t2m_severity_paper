...
# Loading databases
## Lag and Overall
RRVal_lag_list <- vroom("Outputs/Tables/adding_cases/RRVal_lag_gnm.csv.xz")
RR_overall_list <- vroom("Outputs/Tables/adding_cases/RR_overall_gnm.csv.xz")
## Quantiles t2m
...
for (i in 1:stacked_levels) {
  ...
  ggsave(paste0("Outputs/Plots/adding_cases/gnm_", names_stacked_plot[i], "_state_overall_effects.png"),
         plot = plot_final[[i]],
         width = 9,
         height = 7,
         dpi = 300)
...
vroom_write(file = "Outputs/Tables/adding_cases/RR_95_05_t2m_overall.csv.xz", 
            RR_95_05_overall)
...
ggsave(paste0("Outputs/Plots/adding_cases/gnm_all_state_overall_effects.png"),
...
ggsave(paste0("Outputs/Plots/adding_cases/gnm_all_state_on_50th_effects.png"),
...
ggsave(paste0("Outputs/Plots/adding_cases/gnm_scale_all_state_heat_95th_effects.png"),

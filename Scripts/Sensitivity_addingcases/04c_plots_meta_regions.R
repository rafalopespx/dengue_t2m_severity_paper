...
### Overall
res_region<-vroom("Outputs/Tables/adding_cases/meta_gnm_overall_all_regions.csv.xz")
### RR list for lags by percentile
RR_lag_region<-vroom("Outputs/Tables/adding_cases/meta_RR_gnm_lags_all_regions_all_percentile.csv.xz")
...
ggsave(plot = plot_overall_region,
       filename = paste0("Outputs/Plots/adding_cases/plot_overall_regions_all_regions_gnm_meta.png"),
       width = 11,
       height = 9,
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/adding_cases/percentil_effects_regions.png", 
       plot = plot_percent, 
       width = 11, 
       height = 9, 
       dpi = 200)
...
ggsave(filename = "Outputs/Plots/adding_cases/percentil_effects_regions_grid.png", 
...
for (i in 1:5) {
  ...
  ggsave(filename = paste0("Outputs/Plots/adding_cases/figure_SM_", regions_names[i], "_region_meta_analysis.png"),

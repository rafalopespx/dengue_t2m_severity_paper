...
## Overall Meta 
res_state_absolute<-vroom("Outputs/Tables/adding_cases/meta_gnm_overall_for_all.csv.xz")
## RR Meta
# RR_list_absolute<-vroom("Outputs/Tables/adding_cases/meta_gnm_RR_overall_for_all.csv.xz")
## RR over lag Meta
...
## Overall
res_region_absolute<-vroom("Outputs/Tables/adding_cases/meta_gnm_overall_all_regions.csv.xz")
...
vroom_write(table_rr_final_absolute,
            file ="Outputs/Tables/adding_cases/table_1_mht_RR_absolute.csv")

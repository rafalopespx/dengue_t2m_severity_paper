...
#   geom_line(size=1) +
#   geom_text(data = max_rr_state, aes(y = RR, x = temp_mean, label = abbrev_state, col = region))+
#   theme_minimal() +
#   theme(panel.grid.minor = element_blank()) +
...
# 
# ggsave(paste0("Outputs/Plots/gnm_stacked_all_state_overall_effects.png"),
#        plot = plot_stacked_all_states,
#        width = 9,
#        height = 7,
#        dpi = 300)
